                ...
                <div class="max-w-4xl">
                    <header class="mb-8">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
                            <i class="fas fa-file-signature text-blue-500 dark:text-blue-400 mr-3"></i>
                    ...
                    <div class="text-gray-700 dark:text-gray-300 space-y-6">
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">CLÁUSULA PRIMEIRA – DO OBJETO DO
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">CLÁUSULA SEGUNDA – DAS FINALIDADES DO
                                TRATAMENTO</h2>
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">CLÁUSULA TERCEIRA – DO NÃO
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">CLÁUSULA QUARTA – DO CONTROLADOR E DPO
                            </h2>
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">CLÁUSULA QUINTA – DA CONFORMIDADE COM A
                                LGPD</h2>
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">CLÁUSULA SEXTA – DOS DIREITOS DO TITULAR
                            </h2>
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">CLÁUSULA SÉTIMA – CANAL DE COMUNICAÇÃO
                            </h2>
                            <div class="mt-3 p-3 bg-gray-50 dark:bg-[#0D1117] rounded border border-gray-200 dark:border-gray-700">
                                <p class="flex items-center">
                                    <i class="fas fa-envelope text-blue-500 dark:text-blue-400 mr-2"></i>
                                    <span class="text-gray-900 dark:text-white">E-mail:</span>
                                    <span class="ml-2">suporte@indoali.com</span>
                                </p>
                                <p class="flex items-center mt-2">
                                    <i class="fas fa-phone text-blue-500 dark:text-blue-400 mr-2"></i>
                        ...
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">CLÁUSULA OITAVA – DO CONSENTIMENTO LIVRE
                            </h2>
                        ...
                        @auth
                        <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 rounded-lg p-4 mt-6">
                            <i class="fas fa-check-circle text-green-500 dark:text-green-400 mr-2"></i>
                            <span class="text-gray-900 dark:text-white font-medium">Consentimento Confirmado:</span>
                            Você aceitou este termo ao criar sua conta no Indo Ali.
                        </div>
                        @else
                        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50 rounded-lg p-4 mt-6">
                            <i class="fas fa-info-circle text-blue-500 dark:text-blue-400 mr-2"></i>
                            <span class="text-gray-900 dark:text-white font-medium">Informação:</span>

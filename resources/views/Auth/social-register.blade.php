<x-auth-layout authTitle="Complete seu cadastro" authMessage="Para finalizar, aceite nossos termos de uso.">
    <h2 class="text-gray-600 dark:text-gray-400 font-medium text-sm md:text-base">COMPLETE SEU CADASTRO</h2>
    <h3 class="text-gray-900 dark:text-white font-medium text-xl md:text-2xl lg:text-3xl">Aceite os Termos</h3>

    <div
        class="bg-blue-100 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/50 rounded-lg p-4 mt-4 mb-6">
        <div class="flex items-center">
            ...
            <span class="text-blue-800 dark:text-blue-200">Cadastro via Google</span>
            @else
            <img src="https://www.svgrepo.com/show/452196/facebook-1.svg" alt="Facebook" class="w-6 h-6 mr-2">
            <span class="text-blue-800 dark:text-blue-200">Cadastro via Facebook</span>
            @endif
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('social.register.submit') }}">
        ...
        <div class="mb-4">
            ...
            <x-text-input id="name"
                class="block mt-1 w-full md:mt-2 bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-black dark:text-white"
                type="text" name="name" value="{{ session('social_user')['name'] }}" required readonly />
        </div>
        ...
        <div class="mb-6">
            ...
            <x-text-input id="email"
                class="block mt-1 w-full md:mt-2 bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-black dark:text-white"
                type="email" name="email" value="{{ session('social_user')['email'] }}" required readonly />
        </div>

        <div
            class="block mt-4 md:mt-6 p-4 bg-white dark:bg-[#161B22] rounded-lg border border-gray-200 dark:border-gray-700 shadow-lg">
        ...
        <div class="mt-8 flex justify-center md:mt-10">
            <x-primary-button
                class="justify-center md:px-8 md:py-3 md:text-lg bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700">
        ...
        <div
            ...
            <div class="p-6 overflow-y-auto">
                <div class="text-gray-700 dark:text-gray-300">
                    <h3 class="text-lg font-semibold mb-4 text-center text-gray-900 dark:text-white">TERMO DE
                        CONSENTIMENTO PARA TRATAMENTO DE DADOS PESSOAIS – "INDO ALI"</h3>
                    <p class="mb-4">Este Termo de Consentimento formaliza sua autorização expressa, livre, informada e
                        ...
                        a Lei nº 13.709/2018 – Lei Geral de Proteção de Dados (LGPD).</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA PRIMEIRA – DO OBJETO
                        DO CONSENTIMENTO E DOS DADOS TRATADOS</h4>
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA SEGUNDA – DAS
                        FINALIDADES DO TRATAMENTO</h4>
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA TERCEIRA – DO NÃO
                        COMPARTILHAMENTO DE DADOS</h4>
                    <p class="mb-3">Os dados não serão compartilhados com terceiros sem consentimento expresso do
                        titular, exceto em casos de obrigação legal ou para suporte técnico sob contrato de
                        confidencialidade.</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA QUARTA – DO
                        CONTROLADOR E DPO</h4>
                    <p class="mb-3">O titular terá acesso às informações de contato do Controlador e do Encarregado de
                        Dados (DPO), conforme exigido pelo art. 41 da LGPD.</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA QUINTA – DA
                        CONFORMIDADE COM A LGPD</h4>
                    <p class="mb-3">O tratamento observará os princípios da LGPD. Medidas aplicadas incluem criptografia
                        de senhas, controle de acesso restrito, monitoramento de logs e plano de resposta a incidentes.
                    </p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA SEXTA – DOS DIREITOS
                        DO TITULAR</h4>
                    <p class="mb-3">O titular poderá, a qualquer momento, solicitar revogação do consentimento, exclusão
                        da conta, acesso ou atualização de dados, bem como informações sobre o tratamento.</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA SÉTIMA – CANAL DE
                        COMUNICAÇÃO</h4>
                    <p class="mb-3">E-mail: suporte@indoali.com<br>Telefone: (XX) XXXX-XXXX</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA OITAVA – DO
                        CONSENTIMENTO LIVRE</h4>
                    <p class="mb-6">O titular confirma que o consentimento foi concedido de forma livre, sem coação,
                        após leitura e compreensão integral deste Termo.</p>
                </div>
            </div>
    ...
    <div id="terms_modal"
        ...
        <div
            ...
            <div class="p-6 overflow-y-auto">
                <div class="text-gray-700 dark:text-gray-300">
                    <h3 class="text-lg font-semibold mb-4 text-center text-gray-900 dark:text-white">TERMO DE USO DO
                        SISTEMA "INDO ALI"</h3>
                    <p class="mb-4">Este Termo de Uso ("Termo") é um acordo legal entre você, o(a) usuário(a) do
                        sistema, e os desenvolvedores do Projeto "Indo Ali" (doravante denominado "Indo Ali" ou "Nós"),
                        um sistema pensado para conectar usuários a locais, restaurantes e eventos, com base em
                        preferências personalizadas. Ao acessar ou utilizar o "Indo Ali", você manifesta sua
                        concordância integral com este Termo de Uso, com a Política de Privacidade e com a Lei Geral de
                        Proteção de Dados Pessoais (LGPD – Lei nº 13.709/2018). Se você não concordar com estes termos,
                        não deverá utilizar o sistema.</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA PRIMEIRA – DAS
                        CONDIÇÕES GERAIS DE USO</h4>
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA SEGUNDA – DA COLETA E
                        USO DE DADOS PESSOAIS</h4>
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA TERCEIRA – FINALIDADE
                        DA COLETA</h4>
                    <ul class="list-disc pl-5 mb-3 space-y-1">
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA QUARTA – VEDAÇÕES DO
                        USO</h4>
                    <ul class="list-disc pl-5 mb-3 space-y-1">
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA QUINTA – ACEITAÇÃO
                        IMPLÍCITA</h4>
                    <p class="mb-3">O uso do Sistema "Indo Ali" implica em concordância integral e incondicional com
                        este Termo de Uso.</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA SEXTA – DA PROTEÇÃO
                        DOS DADOS</h4>
                    <ul class="list-disc pl-5 mb-3 space-y-1">
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA SÉTIMA – DO
                        COMPARTILHAMENTO DE DADOS</h4>
                    <ul class="list-disc pl-5 mb-3 space-y-1">
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA OITAVA – DOS DIREITOS
                        DO TITULAR DOS DADOS</h4>
                    <ul class="list-disc pl-5 mb-3 space-y-1">
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA NONA – DA
                        IDENTIFICAÇÃO DO RESPONSÁVEL PELO TRATAMENTO DOS DADOS</h4>
                    <p class="mb-3">Projeto "Indo Ali" – Responsável pelo tratamento dos dados: Nome do Encarregado –
                        DPO – CPF/Documento.</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA DÉCIMA – DA
                        RESPONSABILIDADE NA EXATIDÃO DOS DADOS</h4>
                    <p class="mb-3">O usuário é responsável pela veracidade e atualização dos dados fornecidos.</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA DÉCIMA PRIMEIRA – DA
                        TRANSPARÊNCIA</h4>
                    <p class="mb-3">Os direitos dos usuários serão atendidos em até 48 horas para confirmação e até 15
                        dias para demandas complexas.</p>

                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA DÉCIMA SEGUNDA – DADOS
                        DE CRIANÇAS E ADOLESCENTES</h4>
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA DÉCIMA TERCEIRA –
                        DISPOSIÇÕES GERAIS</h4>
                    ...
                    <h4 class="font-semibold mt-6 mb-2 text-blue-600 dark:text-blue-400">CLÁUSULA DÉCIMA QUARTA – DO
                        FORO</h4>
                    <p class="mb-6">Fica eleito o foro da comarca de Belo Horizonte/MG para dirimir eventuais
                        controvérsias.</p>

                    <p class="text-sm italic text-gray-500 dark:text-gray-400 mb-6">Importante: O aceite eletrônico
                        deste termo no site "Indo Ali" confirma o consentimento, nos termos da LGPD.</p>
                </div>
            </div>

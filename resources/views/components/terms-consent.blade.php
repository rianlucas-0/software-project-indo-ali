    ...
    <div
        ...
        <div class="p-6 overflow-y-auto">
            <div class="text-gray-300">
                <h3 class="text-lg font-semibold mb-4 text-center text-white">TERMO DE CONSENTIMENTO PARA TRATAMENTO DE
                ...
                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA PRIMEIRA – DO OBJETO DO CONSENTIMENTO E DOS
                    DADOS TRATADOS</h4>
                ...
                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA SEGUNDA – DAS FINALIDADES DO TRATAMENTO</h4>
                ...
                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA TERCEIRA – DO NÃO COMPARTILHAMENTO DE DADOS
                </h4>
...
<div id="terms_modal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-80 flex items-center justify-center z-50 p-4">
    <div
        ...
        <div class="p-6 overflow-y-auto">
            <div class="text-gray-300">
                <h3 class="text-lg font-semibold mb-4 text-center text-white">TERMO DE USO DO SISTEMA "INDO ALI"</h3>
                ...
                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA PRIMEIRA – DAS CONDIÇÕES GERAIS DE USO</h4>
                ...
                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA SEGUNDA – DA COLETA E USO DE DADOS PESSOAIS
                </h4>
                ...
                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA SÉTIMA – DO COMPARTILHAMENTO DE DADOS</h4>
                <ul class="list-disc pl-5 mb-3 space-y-1">
                ...
                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA OITAVA – DOS DIREITOS DO TITULAR DOS DADOS
                </h4>
                <ul class="list-disc pl-5 mb-3 space-y-1">
                ...
                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA NONA – DA IDENTIFICAÇÃO DO RESPONSÁVEL PELO
                    TRATAMENTO DOS DADOS</h4>
                <p class="mb-3">Projeto "Indo Ali" – Responsável pelo tratamento dos dados: Nome do Encarregado – DPO –
                    CPF/Documento.</p>

                <h4 class="font-semibold mt-6 mb-2 text-blue-400">CLÁUSULA DÉCIMA – DA RESPONSABILIDADE NA EXATIDÃO DOS
                    DADOS</h4>
                ...
                <p class="text-sm italic text-gray-400 mb-6">Importante: O aceite eletrônico deste termo no site "Indo

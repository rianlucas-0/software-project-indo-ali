...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $local->title }} | Indo Ali</title>
    ...
    <body class="bg-[#0D1117] font-sans text-gray-300">
        <main class="max-w-7xl mx-auto px-4 py-8 md:py-12">
            ...
            <div class="mb-8 rounded-xl overflow-hidden shadow-2xl">
                <img src="{{ asset('img/' . $local->image) }}" alt="{{ $local->title }}" class="w-full h-auto object-cover max-h-[600px]">
            </div>
            @endif
                    ...
                    <div class="bg-[#161B22] rounded-xl p-6 top-4 mb-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="text-white">Seg-Sex: 8h-20h</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 pt-6 border-t border-gray-700">
                            ...
                            target="_blank" class="block w-full bg-blue-600 hover:bg-blue-700 text-white text-center py-3 px-4 rounded-lg font-medium transition">

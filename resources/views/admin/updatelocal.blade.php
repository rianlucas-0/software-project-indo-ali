        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white dark:bg-[#161B22] shadow-lg rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                <div class="flex items-center mb-6">
                    <i class="fas fa-edit text-blue-500 dark:text-blue-400 mr-3 text-xl"></i>
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Editar local</h2>
                </div>
                ...
                <form action="{{ route('admin.updatelocal', $local->id) }}" method="post" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-gray-50 dark:bg-[#1E2229] p-5 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <x-text-input id="title" name="title" type="text" value="{{ old('title', $local->title) }}" 
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="4"
                                    class="w-full bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white rounded-md focus:border-blue-500 focus:ring-blue-500 dark:focus:border-blue-400 dark:focus:ring-blue-400">{{ old('description', $local->description) }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="category" id="category"
                                    ...
                                    <option value="academia" {{ $local->category == 'academia' ? 'selected' : '' }}>Academia</option>
                                    <option value="bar" {{ $local->category == 'bar' ? 'selected' : '' }}>Bar</option>
                                    <option value="biblioteca" {{ $local->category == 'biblioteca' ? 'selected' : '' }}>Biblioteca</option>
                                    <option value="boliche" {{ $local->category == 'boliche' ? 'selected' : '' }}>Boliche</option>
                                    <option value="boate" {{ $local->category == 'boate' ? 'selected' : '' }}>Boate</option>
                                    <option value="cachoeira" {{ $local->category == 'cachoeira' ? 'selected' : '' }}>Cachoeira</option>
                                    <option value="cafe" {{ $local->category == 'cafe' ? 'selected' : '' }}>Café</option>
                                    <option value="casa_shows" {{ $local->category == 'casa_shows' ? 'selected' : '' }}>Casa de Shows</option>
                                    <option value="centro_cultural" {{ $local->category == 'centro_cultural' ? 'selected' : '' }}>Centro Cultural</option>
                                    <option value="centro_historico" {{ $local->category == 'centro_historico' ? 'selected' : '' }}>Centro Histórico</option>
                                    <option value="cinema" {{ $local->category == 'cinema' ? 'selected' : '' }}>Cinema</option>
                                    <option value="clube_social" {{ $local->category == 'clube_social' ? 'selected' : '' }}>Clube Social</option>
                                    <option value="comida_asiatica" {{ $local->category == 'comida_asiatica' ? 'selected' : '' }}>Comida Asiática</option>
                                    <option value="comida_tipica" {{ $local->category == 'comida_tipica' ? 'selected' : '' }}>Comida Típica</option>
                                    <option value="comida_vegetariana" {{ $local->category == 'comida_vegetariana' ? 'selected' : '' }}>Comida Vegetariana</option>
                                    <option value="escape_room" {{ $local->category == 'escape_room' ? 'selected' : '' }}>Escape Room</option>
                                    <option value="escola" {{ $local->category == 'escola' ? 'selected' : '' }}>Escola</option>
                                    <option value="estadio" {{ $local->category == 'estadio' ? 'selected' : '' }}>Estádio</option>
                                    <option value="feira_livre" {{ $local->category == 'feira_livre' ? 'selected' : '' }}>Feira Livre</option>
                                    <option value="galeria_arte" {{ $local->category == 'galeria_arte' ? 'selected' : '' }}>Galeria de Arte</option>
                                    <option value="hamburgueria" {{ $local->category == 'hamburgueria' ? 'selected' : '' }}>Hamburgueria</option>
                                    <option value="hotel" {{ $local->category == 'hotel' ? 'selected' : '' }}>Hotel</option>
                                    <option value="igreja_historica" {{ $local->category == 'igreja_historica' ? 'selected' : '' }}>Igreja Histórica</option>
                                    <option value="jardim_botanico" {{ $local->category == 'jardim_botanico' ? 'selected' : '' }}>Jardim Botânico</option>
                                    <option value="karaoke" {{ $local->category == 'karaoke' ? 'selected' : '' }}>Karaokê</option>
                                    <option value="kart" {{ $local->category == 'kart' ? 'selected' : '' }}>Kart</option>
                                    <option value="loja" {{ $local->category == 'loja' ? 'selected' : '' }}>Loja</option>
                                    <option value="loja_artesanato" {{ $local->category == 'loja_artesanato' ? 'selected' : '' }}>Loja de Artesanato</option>
                                    <option value="massagem" {{ $local->category == 'massagem' ? 'selected' : '' }}>Massagem</option>
                                    <option value="mirante" {{ $local->category == 'mirante' ? 'selected' : '' }}>Mirante</option>
                                    <option value="monumento" {{ $local->category == 'monumento' ? 'selected' : '' }}>Monumento</option>
                                    <option value="museu" {{ $local->category == 'museu' ? 'selected' : '' }}>Museu</option>
                                    <option value="padaria" {{ $local->category == 'padaria' ? 'selected' : '' }}>Padaria</option>
                                    <option value="parque" {{ $local->category == 'parque' ? 'selected' : '' }}>Parque</option>
                                    <option value="parque_ambiental" {{ $local->category == 'parque_ambiental' ? 'selected' : '' }}>Parque Ambiental</option>
                                    <option value="parque_aquatico" {{ $local->category == 'parque_aquatico' ? 'selected' : '' }}>Parque Aquático</option>
                                    <option value="parque_diversoes" {{ $local->category == 'parque_diversoes' ? 'selected' : '' }}>Parque de Diversões</option>
                                    <option value="pet_shop" {{ $local->category == 'pet_shop' ? 'selected' : '' }}>Pet Shop</option>
                                    <option value="pizzaria" {{ $local->category == 'pizzaria' ? 'selected' : '' }}>Pizzaria</option>
                                    <option value="ponto_turistico" {{ $local->category == 'ponto_turistico' ? 'selected' : '' }}>Ponto Turístico</option>
                                    <option value="pousada" {{ $local->category == 'pousada' ? 'selected' : '' }}>Pousada</option>
                                    <option value="praca_esportes" {{ $local->category == 'praca_esportes' ? 'selected' : '' }}>Praça de Esportes</option>
                                    <option value="praia" {{ $local->category == 'praia' ? 'selected' : '' }}>Praia</option>
                                    <option value="quadra_esportes" {{ $local->category == 'quadra_esportes' ? 'selected' : '' }}>Quadra de Esportes</option>
                                    <option value="resort" {{ $local->category == 'resort' ? 'selected' : '' }}>Resort</option>
                                    <option value="restaurante" {{ $local->category == 'restaurante' ? 'selected' : '' }}>Restaurante</option>
                                    <option value="rua_famosa" {{ $local->category == 'rua_famosa' ? 'selected' : '' }}>Rua Famosa</option>
                                    <option value="shopping" {{ $local->category == 'shopping' ? 'selected' : '' }}>Shopping</option>
                                    <option value="sitio_arqueologico" {{ $local->category == 'sitio_arqueologico' ? 'selected' : '' }}>Sítio Arqueológico</option>
                                    <option value="sorveteria" {{ $local->category == 'sorveteria' ? 'selected' : '' }}>Sorveteria</option>
                                    <option value="spa" {{ $local->category == 'spa' ? 'selected' : '' }}>Spa</option>
                                    <option value="teatro" {{ $local->category == 'teatro' ? 'selected' : '' }}>Teatro</option>
                                    <option value="trilha" {{ $local->category == 'trilha' ? 'selected' : '' }}>Trilha</option>
                                    <option value="universidade" {{ $local->category == 'universidade' ? 'selected' : '' }}>Universidade</option>
                                    <option value="vista_panoramica" {{ $local->category == 'vista_panoramica' ? 'selected' : '' }}>Vista Panorâmica</option>
                                    <option value="zoo_aquario" {{ $local->category == 'zoo_aquario' ? 'selected' : '' }}>Zoológico/Aquário</option>
                                    <option value="outro" {{ $local->category == 'outro' ? 'selected' : '' }}>Outro</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-[#1E2229] p-5 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-4" id="existing-images">
                            ...
                            <div class="relative group overflow-hidden rounded-lg border border-gray-300 dark:border-gray-700">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="images"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">Clique para adicionar mais imagens</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">PNG, JPG (Máx. 7 imagens no total)</p>
                                </div>
                    ...
                    <div class="bg-gray-50 dark:bg-[#1E2229] p-5 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="address_number" name="address_number" type="text" value="{{ old('address_number', $local->address_number) }}"
                                    class="w-full bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white" />
                            </div>

                            <div class="sm:col-span-2">
                                <x-input-label for="address" :value="__('Rua')" class="text-gray-700 dark:text-gray-300" />
                                <x-text-input id="address" name="address" type="text" value="{{ old('address', $local->address) }}"
                                    class="w-full bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white" />
                            </div>

                            <div>
                                <x-input-label for="neighborhood" :value="__('Bairro')" class="text-gray-700 dark:text-gray-300" />
                                <x-text-input id="neighborhood" name="neighborhood" type="text" value="{{ old('neighborhood', $local->neighborhood) }}"
                                    class="w-full bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white" />
                            </div>
                            ...
                            <div>
                                ...
                                <select name="state" id="state"
                                    ...
                                    <option value="DF" {{ $local->state == 'DF' ? 'selected' : '' }}>Distrito Federal</option>
                                    <option value="ES" {{ $local->state == 'ES' ? 'selected' : '' }}>Espírito Santo</option>
                                    <option value="GO" {{ $local->state == 'GO' ? 'selected' : '' }}>Goiás</option>
                                    <option value="MA" {{ $local->state == 'MA' ? 'selected' : '' }}>Maranhão</option>
                                    <option value="MT" {{ $local->state == 'MT' ? 'selected' : '' }}>Mato Grosso</option>
                                    <option value="MS" {{ $local->state == 'MS' ? 'selected' : '' }}>Mato Grosso do Sul</option>
                                    <option value="MG" {{ $local->state == 'MG' ? 'selected' : '' }}>Minas Gerais</option>
                                    ...
                                    <option value="RJ" {{ $local->state == 'RJ' ? 'selected' : '' }}>Rio de Janeiro</option>
                                    <option value="RN" {{ $local->state == 'RN' ? 'selected' : '' }}>Rio Grande do Norte</option>
                                    <option value="RS" {{ $local->state == 'RS' ? 'selected' : '' }}>Rio Grande do Sul</option>
                                    <option value="RO" {{ $local->state == 'RO' ? 'selected' : '' }}>Rondônia</option>
                                    <option value="RR" {{ $local->state == 'RR' ? 'selected' : '' }}>Roraima</option>
                                    <option value="SC" {{ $local->state == 'SC' ? 'selected' : '' }}>Santa Catarina</option>
                    ...
                    <div class="bg-gray-50 dark:bg-[#1E2229] p-5 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="phone" name="phone" type="text" value="{{ old('phone', $local->phone) }}"
                                    class="w-full bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white" />
                            </div>

                            <div class="sm:col-span-2">
                                <x-input-label for="contact_email" :value="__('Email de contato')" class="text-gray-700 dark:text-gray-300" />
                                <x-text-input id="contact_email" name="contact_email" type="text" value="{{ old('contact_email', $local->contact_email) }}"
                                    class="w-full bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 dark:bg-[#1E2229] p-5 rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <div x-show="featuresOpen" @click.away="featuresOpen = false"
                                ...
                                <div class="space-y-2 p-2">
                                    ...
                                    <div class="flex items-center p-2 hover:bg-gray-100 dark:hover:bg-[#1E2229] rounded">
                                        <input type="checkbox" id="feature_{{ $value }}" name="features[]" value="{{ $value }}" {{ in_array($value, $features) ? 'checked' : '' }}
                                            class="rounded border-gray-300 dark:border-gray-600 text-blue-500 focus:ring-blue-500 dark:focus:ring-blue-400 h-4 w-4">
                                        <label for="feature_{{ $value }}" class="ml-2 text-sm text-gray-700 dark:text-gray-300">{{ $label }}</label>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="mt-3 flex flex-wrap gap-2" id="selected-features">
                            ...
                            @endphp
                            <div class="bg-blue-100 dark:bg-blue-600/20 text-blue-800 dark:text-blue-400 text-xs px-2 py-1 rounded-full flex items-center">
                                <span>{{ $label }}</span>
                            </div>
                            @endforeach
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" id="day_{{ $dayLower }}" name="working_days[]" value="{{ $dayLower }}" {{ $isActive ? 'checked' : '' }}
                                        class="rounded border-gray-300 dark:border-gray-600 text-blue-500 focus:ring-blue-500 dark:focus:ring-blue-400 h-4 w-4">
                                    <label for="day_{{ $dayLower }}" class="ml-2 text-sm text-gray-700 dark:text-gray-300">{{ $day }}</label>
                                </div>

                                <div class="flex items-center space-x-2 pl-6">
                                    <div class="flex-1">
                                        <x-input-label for="opening_time_{{ $dayLower }}" :value="__('Abertura')" class="sr-only" />
                                        <x-text-input type="time" name="opening_time_{{ $dayLower }}" value="{{ $openingTime }}"
                                    ...
                                    <div class="flex-1">
                                        <x-input-label for="closing_time_{{ $dayLower }}" :value="__('Fechamento')" class="sr-only" />
                                        <x-text-input type="time" name="closing_time_{{ $dayLower }}" value="{{ $closingTime }}"
                                            class="w-full bg-white dark:bg-[#0D1117] border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-sm p-2" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <a href="{{ route('admin.all_local') }}" class="w-full">
                            <x-primary-button class="w-full justify-center bg-gray-600 hover:bg-gray-700 dark:bg-gray-500 dark:hover:bg-gray-600 text-white">

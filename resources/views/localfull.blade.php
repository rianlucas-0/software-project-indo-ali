            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-[#161B22] rounded-xl p-6">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                            @for($i = 1; $i <= 6; $i++) <div
                                class="rounded-lg overflow-hidden cursor-pointer hover:opacity-90 transition">
                                <img src="https://placehold.co/300x200/161B22/3B82F6?text=Imagem+{{ $i }}"
                                    alt="Imagem {{ $i }}" class="w-full h-32 object-cover">
                        </div>
                        @endfor
                    </div>
                </div>
